...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ref={ref}
    className={cn(
      "left-0 top-0 w-full data-[animate=in]:fade-in data-[animate=out]:fade-out data-[animate=in]:slide-in-from-top-0 data-[animate=out]:slide-out-to-top-0 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 md:absolute md:w-auto ",
      className,
    )}
    {...props}
  />
